...
var attributeGrammar = [93]string{
	...
	"for @firStat ( Decl AssignOp Expr ; RelExpr ; AssignStat ) StatBlock ;",
	"{ StatementTail }",
	"Statement",
	"@ArithExpr ArithExpr RelExprTail",
	"@RelExpr @ArithExpr ArithExpr @Relop RelOp @ArithExpr ArithExpr @3:2 @2:1",
	"@RelOp RelOp @ArithExpr ArithExpr @3:2",
	"EPSILON",
	"@Term Term @2:1 ArithExprTail",
	"@AddOp AddOp @Term Term @3:2 @ArithExpr @2:2 ArithExprTail",
	"@Factor Factor @2:1 TermTail",
	"@MultOp MultOp @Factor Factor @3:2 TermTail",
	"( @ArithExpr ArithExpr @2:1 )",
	"not @not @2:1 @Factor Factor",
	"EvalExprHead @2:1",
	"floatNum @floatNum",
	"intNum @intNum",
	"+ @+ @2:1",
	...
	"put @putStat ( Expr ) @2:1 ;",
	"get ( Variable ) ;",
	"if ( Expr ) then StatBlock else StatBlock ;",
	"Num @Num",
	"@Sign Sign @Factor Factor",
}
