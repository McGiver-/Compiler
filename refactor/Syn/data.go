...
var attributeGrammar = [93]string{
	...
	"ClassDecl Prog",
	"program FuncBody ;",
	"class id @id Inherit @InheritList:1 { ClassVarDecl @MemberList:1 } ; @ClassDecl:3",
	": id @id InheritList",
	"EPSILON @EPSILON",
	", id @id:0:true  InheritList",
	"EPSILON",
	"Decl ClassVarDeclTail",
	"Type @Type:1 id @id",
	"ArraySizeTail ; @DimList:1 @VarDecl:3:true ClassVarDecl",
	"Type @Type:1 id @id FuncHeadTail",
	"@ScopeSpec :: id @id ( FParams @FparamList:1 )",
	"@EmptyScope ( FParams @FparamList:1 )",
	"{ FuncVarDecl @StatBlock }",
	"( FParams @FparamList:1 ) ; @FuncDecl:4:true ClassVarDecl",
	"StatementNoAssign StatementTail",
	"id @id ArraySizeTail @DimList:1 @VarDecl:4:true ; FuncVarDecl",
	"[ intNum @intNum:0:true ]",
	"ArraySize ArraySizeTail",
	"float @float",
	"id @id",
	"int @int",
	"Type @Type:1 id @id ArraySizeTail @DimList:1 @Fparam:3:true FParamsTail",
	", FParams",
	"EPSILON",
	"Decl FuncDefListTail",
	"FuncDef FuncDefList",
	"FuncHead FuncBody @FuncDef:5:true ;",
...
var predictionTable = map[string]map[string]int{
	...
	"ClassVarDecl":      map[string]int{"float": 9, "id": 9, "int": 9, "}": 8},
	...
	"ArraySizeTail":     map[string]int{"[": 20, ";": 6, ")": 8, ",": 8},
