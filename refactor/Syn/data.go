...
var attributeGrammar = [93]string{
	...
	"( @FparamList FParams ) ; @FuncDecl @4:4 @2:1 ClassVarDecl",
	...
	"@Var Variable @2:1 @2:1 AssignStatTail @3:1",
	"AssignOp @Expr Expr",
	"@AssignStat AssignStat @Stat @2:2 @2:1 ;",
	"StatementNoAssign @Stat @2:2 @2:1",
	"Statement StatementTail",
	"for @forStat ( Decl AssignOp @Expr Expr ; @Expr Expr ; @AssignStat AssignStat ) @StatBlock StatBlock @7:1 ;",
	"{ StatementTail }",
	"Statement",
	"@ArithExpr ArithExpr @2:1 RelExprTail @2:1",
	"@RelExpr @Expr Expr @Relop RelOp @Expr Expr @3:2",
	...
	"if @ifStat ( @Expr Expr ) then @StatBlock StatBlock else @StatBlock StatBlock @4:1 ;",
	"@Num Num @2:1",
